...
PROJECT_REPO ?= github.com/holybitsllc/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION ?= 4.52.6
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-cloudflare
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-cloudflare_v4.52.6
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/cloudflares/03-delete.yaml.tmpl.
