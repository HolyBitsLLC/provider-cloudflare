...
func (tr *IdentityProvider) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"config[*].api_token": "config[*].apiTokenSecretRef", "config[*].client_secret": "config[*].clientSecretSecretRef", "config[*].idp_public_cert": "config[*].idpPublicCertSecretRef", "scim_config[*].secret": "scimConfig[*].secretSecretRef"}
}
