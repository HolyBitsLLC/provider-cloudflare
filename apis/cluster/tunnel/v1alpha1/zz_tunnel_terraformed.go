...
func (tr *Tunnel) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"secret": "secretSecretRef", "tunnel_token": "status.atProvider.tunnelToken"}
}
...
// GetInitParameters of this Tunnel
func (tr *Tunnel) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
